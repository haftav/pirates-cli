...
describe('parseMove tests', () => {
    test('moving north returns northward move', () => {
        expect(parseMove(['north', undefined])).toEqual(expect.arrayContaining(northMoveArray))
    });
    test('moving south returns southward move', () => {
        expect(parseMove(['south', undefined])).toEqual(expect.arrayContaining(southMoveArray))
    });

    test('moving east returns eastward move', () => {
        expect(parseMove(['east', undefined])).toEqual(expect.arrayContaining(eastMoveArray))
    });

    test('moving west returns westward move', () => {
        expect(parseMove(['west', undefined])).toEqual(expect.arrayContaining(westMoveArray))
    });
});